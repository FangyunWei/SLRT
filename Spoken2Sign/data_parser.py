...
class OpenPose(Dataset):
    ...
    def __init__(self, data_folder, img_folder='images',
        ...
        self.video_id = kwargs.pop('video_id', None)
        self.video_len = kwargs.pop('video_len', 0)
        self.dataset_name = kwargs.pop('dataset_name', 'Phoenix-2014T')
        if 'phoenix' in self.dataset_name.lower():
            self.img_size = (260,210)
        elif 'csl' in self.dataset_name.lower():
            self.img_size = (512,512)
        elif self.dataset_name.lower() in ['wlasl', 'msasl']:
        ...
        self.img_paths = [self.video_id+'_{:03d}'.format(i) for i in range(self.video_len)]
    ...
    def read_item(self, img_path):
        ...
        output_dict = {'fn': img_path,
                       'img_path': img_path, 'img': self.img_size}
