...
def parse_config(argv=None):
    ...
    parser.add_argument('--img_folder', type=str, default='images_phoenix',
    ...
    parser.add_argument('--joints_to_fix', default=-1, type=int,
                        nargs='*',
                        help='Indices of joints to be fixed')
    # parser.add_argument('--start_idx', default=0, type=int,
    #                     help='Start index of video ids')
    # parser.add_argument('--end_idx', default=100, type=int,
    #                     help='End index of video ids')
    parser.add_argument('--init_idx', default=0, type=int,
                        help='initial index of video ids of the job')
    parser.add_argument('--num_per_proc', default=1, type=int,
                        help='number of videos per process')
    parser.add_argument('--identifier', default='', type=str, help='identify dir names')
    parser.add_argument('--keypoints_folder', default='', type=str,
                        help='The folder where the keypoints file is stored')
    parser.add_argument('--smooth_loss_weight', default=8e3, type=float,
                        help='Smooth loss weight')
    parser.add_argument('--unseen_left_weight', default=3e3, type=float,
                        help='Loss weight for unseen left hand joints')
    parser.add_argument('--unseen_right_weight', default=3e3, type=float,
                        help='Loss weight for unseen right hand joints')
    parser.add_argument('--upstanding_loss_weight', default=3e5, type=float,
                        help='Loss weight of the loss item to keep upstanding')
    ...
    parser.add_argument('--dataset_to_fitting', default='Phoenix-2014T', type=str,
                        help='The dataset name')
    parser.add_argument('--only_kps', default=0, type=int, choices=[0,1],
                        help='whether only generate keypoints')
    parser.add_argument('--aug_angle', default=0, type=float,
                        help='3d keypoints augmentation')
    parser.add_argument('--param_file', default=None, type=str,
