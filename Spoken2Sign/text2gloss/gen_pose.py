...
def main():
    ...
    outputs = {}
    save_inte = 500
    for k, batch_data in tqdm(enumerate(dataloader), desc='[Generating keypoints of {:s} of {:s}, {:d} per gpu]'.format(args.split, dataset_name, len(dataloader))):
        # print(batch_data['recognition_inputs']['sgn_videos'].shape)
        ...
        video_id = batch_data['recognition_inputs']['name'][0]
        ...
        assert pose_results.shape == (batch_data['recognition_inputs']['sgn_lengths'][0], 133, 3)
