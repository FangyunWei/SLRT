...
import math, pickle
DATASETS = ['phoenix','phoenix2014tsi','phoenix2014','phoenix2014si','csl','cslr', 'csl_syn_gt',
            'wlasl2000','tvb','phoenixcomb','phoenix_syn','phoenix_syn_gt', 'phoenix_syn_smplx', 'phoenix_syn_smplx_gt']
...
def load_config(path="configs/default.yaml") -> dict:
    ...
    if cfg['data'].get('multi', False)==False:
        ...
        new_datacfg = {
            ...
            'render_cfg_file': cfg['data'].get('render_cfg_file', None),
            'aug_angle': cfg['data'].get('aug_angle', 0),
